...
pixi add python-blosc2
# for installing globally
pixi global install python-blosc2
```
...
It is possible to list all of the versions of `python-blosc2` available on your platform:
...
```
pixi search python-blosc2 --channel conda-forge
```
